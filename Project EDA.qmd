...
diabetes |> ggplot(aes(x = PhysActivity, fill = Diabetes_binary)) + geom_bar(position = "fill") + theme_minimal() + labs(title = "Diabetes vs Physical Activity", x = "Physical Activity", y = "Proportion")
```
